...
namespace StudentsWebApi.Controllers
{
    ...
    public class ScoresController : ControllerBase
    {
        ...
        public ScoresController(StudentsWebApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Score>>> GetScores()
        {
          if (_context.Scores == null)
          {
            ...
            return await _context.Scores.Include(x => x.Student).Include(x => x.Assessment).ToListAsync();
        }
        ...
        public async Task<ActionResult<Score>> PostScore(Score score)
        {
          if (_context.Scores == null)
          {
              return Problem("Entity set 'StudentsWebApiContext.Scores'  is null.");
          }
